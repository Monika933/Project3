$(document).ready(function () {
        ...
        $("#forgotPassSubmit").on("click", function(event) {
          event.preventDefault();
            ...
            if ($("#usernameForgotPass").val().length>0) {
              ...
              $.ajax("/api/clients/" + usernameEntered, {
                type: "GET",
    ...
    // pulled from the users account in the database
                if (dbClient == null) {
                  ...
                  var secQues1 = dbClient.secQuestion1;
                  var secQues2 = dbClient.secQuestion2;
                  var secQues3 = dbClient.secQuestion3;
                  var secQuesAns1 = dbClient.secQuestionAnswer1;
                  var secQuesAns2 = dbClient.secQuestionAnswer2;
                  var secQuesAns3 = dbClient.secQuestionAnswer3;
                  var clientId = dbClient.id;
    //STEP 3.  Append Security Questions and answers to page  
                  $("#secQuesInputs").empty()                        
                  $("#secQuesInputs").append(`        
                        <div class="row">
                            <div class="offset-md-3 col-md-6 bgwhite scheduleAppointmentModelSettings">
                            ...
                            <div class="offset-md-3 col-md-3 bgwhite scheduleAppointmentModelSettings">
                                <button id="forgotPassSubmit1" class="btn btn-primary">Submit</button>
                            </div>
                            <div class="col-md-3 bgwhite scheduleAppointmentModelSettings">
